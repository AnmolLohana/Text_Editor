...
#####view
#view icons
toolbar_icon = tk.PhotoImage(file='toolbar.PNG')
statusbar_icon = tk.PhotoImage(file='statusbar.PNG')
...
#####color theme
light_default_icon = tk.PhotoImage(file='light.PNG')
light_plus_icon = tk.PhotoImage(file='lightplus.PNG')
dark_icon = tk.PhotoImage(file='dark.PNG')
red_icon = tk.PhotoImage(file='red.PNG')
monokai_icon = tk.PhotoImage(file='monokai.PNG')
night_blue_icon = tk.PhotoImage(file='nightblue.PNG')
...
#'colorName':('textColor', 'BackgroundColor')
color_dict = {
...
itallic_icon = tk.PhotoImage(file='itallic.PNG')
...
center_icon = tk.PhotoImage(file='center.PNG')
...
#we can pass any argument inside function but not empty because of bind
...
#binding function with combobox
...
#setting default style and size
...
def count(event=None):
    ...
    if text_editor.edit_modified():
        ...
        #characters = len(text_editor.get(1.0, 'end-1c').replace(' ', '')) if you don't want to count spaces
...
count = 0
#for both key and value pair will use color_dict.items()
#but for only value will use color_dict
for i in color_dict:
